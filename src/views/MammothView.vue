<template>
    <div class="site-details mammoth-view">
        <nav class="top-nav">
            <div class="container">
                <ul>
                    <li>
        ...
        <div class="container">
            ...
            <div class="btns">
                <router-link to="/pharoto-view"><i class='bx bxs-chevrons-left'></i> {{ home_data.home.web_view_btns.prev }}</router-link>
                <p>5/6</p>
                <router-link to="/gympo-view">{{ home_data.home.web_view_btns.next }} <i class='bx bxs-chevrons-right'></i></router-link>
            </div>
        </div>
