<template>
    <div class="site-details dashboard-view">
        ...
        <div class="container">
            ...
            <div class="video">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/aCnr200pSAQ?autoplay=1&mute=1"
            ...
            <div class="btns">
                ...
                <p>1/5</p>
                <a href="/off-view">{{ home_data.home.web_view_btns.next }} <i class='bx bxs-chevrons-right'></i></a>
            </div>
        </div>
